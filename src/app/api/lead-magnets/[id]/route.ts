    ...
    if (existing) {
      updated = await prisma.leadMagnet.update({
        ...
        data: {
          ...
          ...(data.fileUrlUa !== undefined && { fileUrlUa: data.fileUrlUa }),
          ...(data.fileNameUa !== undefined && { fileNameUa: data.fileNameUa }),
          ...(data.fileSizeUa !== undefined && { fileSizeUa: data.fileSizeUa }),
          ...(data.fileUrlPl !== undefined && { fileUrlPl: data.fileUrlPl }),
          ...(data.fileNamePl !== undefined && { fileNamePl: data.fileNamePl }),
          ...(data.fileSizePl !== undefined && { fileSizePl: data.fileSizePl }),
      ...
      if (def) {
        updated = await prisma.leadMagnet.create({
          data: {
            ...
            fileUrlUa: data.fileUrlUa ?? def.fileUrlUa,
            fileNameUa: data.fileNameUa ?? def.fileNameUa,
            fileSizeUa: data.fileSizeUa ?? def.fileSizeUa,
            fileUrlPl: data.fileUrlPl ?? def.fileUrlPl,
            fileNamePl: data.fileNamePl ?? def.fileNamePl,
            fileSizePl: data.fileSizePl ?? def.fileSizePl,
