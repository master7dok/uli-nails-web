// Shared default data for Uliana Nails
// Used by seed.mjs, auto-init.mjs, and as a resilient fallback in Next.js pages
...
export const defaultServices: DefaultService[] = [
  ...
  },
  {
    ...
    descriptionUa: "Моделювання на нижніх або верхніх формах, тонкий торець, витончена салонна форма.",
    pricePln: 200,
    durationMin: 120,
    isPopular: true,
    sortOrder: 6,
  },
  {
    ...
    descriptionUa: "Максимальна довжина з посиленою стресовою зоною, ідеальна салонна або екстра-форма.",
    pricePln: 180,
    durationMin: 150,
    isPopular: false,
    sortOrder: 7,
  },
  {
    ...
    descriptionUa: "Ензимний пілінг, вітамінна маска, теплий парафін та розслабляючий масаж кистей.",
    pricePln: 80,
    durationMin: 40,
    isPopular: false,
    sortOrder: 8,
  },
  {
    ...
    descriptionUa: "Глибоке молекулярне відновлення ламких та пошкоджених нігтів зсередини під UV-теплом.",
    pricePln: 80,
    durationMin: 45,
    isPopular: false,
    sortOrder: 9,
...
export const defaultCourses: DefaultCourse[] = [
  {
    id: "course-1",
...
export const defaultPortfolio: DefaultPortfolioItem[] = [
  {
    id: "portfolio-1",
